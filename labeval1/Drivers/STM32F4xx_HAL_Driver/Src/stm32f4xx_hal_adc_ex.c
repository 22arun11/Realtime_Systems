...
/* Private define ------------------------------------------------------------*/
/* ADC Error Code */
#define HAL_ADC_ERROR_INTERNAL          0x01U   /*!< ADC IP internal error (parameters, timeout or analog error) */
#define HAL_ADC_STATE_RESET             0x00U   /*!< ADC not yet initialized or disabled        */
#define HAL_ADC_STATE_READY             0x01U   /*!< ADC peripheral ready for use              */
#define HAL_ADC_STATE_TIMEOUT           0x03U   /*!< Timeout state                            */
#define HAL_ADC_ERROR_DMA               0x04U
#define HAL_ADC_STATE_ERROR_DMA   		0x08U
#define HAL_ADC_STATE_ERROR_DMA         0x20U   /*!< DMA transfer error */
#define HAL_ADC_STATE_REG_OVR           0x40U   /*!< ADC regular group overrun */
#define HAL_ADC_STATE_ERROR_CONFIG      0x80U
